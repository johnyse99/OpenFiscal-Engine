...
/**
 * Spring Data JPA repository for persisting immutable fraud alerts.
 */
public interface SpringDataAuditLogRepository extends JpaRepository<FraudAlertJpaEntity, UUID> {
}