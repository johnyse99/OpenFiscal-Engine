 ...
 */
package com.openfiscal.payment.infrastructure.adapter.in.web.dto;

import com.openfiscal.payment.application.port.in.FinancialReconciliationUseCase.ProcessPaymentCommand;

import java.math.BigInteger;
import java.time.Instant;

/**
 * Webhook DTO representing an incoming banking payment payload (e.g., SPEI,
 * CoDi, Open Banking API).
 */
